...
int ReadData(unsigned char address,unsigned char count,unsigned char * buff) /*多字节*/
{  
//	unsigned char i;
//	Start();
//	writebyte(0xa2); /*写命令*/
...
{   
	...
	g8563_Store[0]=BCDtoDEC(g8563_Store[0]);
	g8563_Store[1]=BCDtoDEC(g8563_Store[1]);	
	g8563_Store[2]=BCDtoDEC(g8563_Store[2]);	
	g8563_Store[3]=BCDtoDEC(g8563_Store[3]);
	g8563_Store[4]=BCDtoDEC(g8563_Store[4]);	
	g8563_Store[5]=BCDtoDEC(g8563_Store[5]);	
