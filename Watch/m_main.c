...
static void itemLoader(byte num)
{
	...
	setMenuOption_P(num++, PSTR(STR_TAILNO), menu_tailnum[0], tailnum_select); 	//尾号选择
	setMenuOption_P(num++, PSTR(STR_MODE), menu_mode, mode_select);    					//模式设置
