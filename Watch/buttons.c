...
volatile uint8_t dir_flag = 2; /* 方向标志 0: 顺时?? 1: 逆时?? 2: 未动状???*/
...
//	
//	}
//	if(key_click_flag == 0)	/*如果没有键按下（高电平），将一些标志位及时清零*/
//	{
//		key_lock = 0;	/*自锁标志位清0*/
//		//key_count = 0;	/*按键去抖动延时计数器清零*/
//		isPressed[BTN_2] = 1;
//	}
//	else //if(key_lock == 0)	/*如果有按键按下，且是第一次按下*/
//	{
//		
//		{
//			key_count = 0;
//			//key_lock = 1;/*自锁标志位置位，避免一直触发*/
//			isPressed[BTN_2] = 0;
//		}
//	}
...
//	{
//		if(key_count > 100)
//		//if(key_value == GPIO_PIN_RESET )//wei change 2022.5.31 RESET 改为GPIO_PIN_RESET
//		{
//	//		DeepSleepFlag=0;
//	//		OLED_ON();
