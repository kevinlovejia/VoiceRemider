...
extern const byte menu_mode[];
extern const byte menu_threemode[][128];	
extern const byte menu_tailnum[][128];
extern const byte arial_font[][128];
extern const byte numFont11x16[][22];
...
//wei add 2022.8.11
extern const byte noEntering[];
extern const byte driving[];
extern const byte textDisplay[][32];
extern const byte test_display[];
